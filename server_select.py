...
def handle_client_exit(sock): #關閉之後 移除清單
...
while 1:
    ...
    try:
        read_sockets,write_sockets,error_sockets =\ #select()函式將阻塞程式流程，直到上述任一「偵聽對象」有動靜，才會繼續往下執行。
    ...
    for sock in read_sockets:
        ...
        #New connection
        if sock == server_socket: #建立連線的客戶端清單
